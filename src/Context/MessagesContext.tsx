...
import { compressImage, deleteFileById, uploadFileAndGetId } from '../utils/uploadFileAndGetId';
...
export const MessagesProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [conversationPageSize] = useState(1000);
    ...
    const sendFileMessage = async (convId: number | undefined, file: File, userId?: number) => {
        ...
        try {
            fileId = await uploadFileAndGetId(
